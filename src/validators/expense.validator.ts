...
const ExpenseRequestSchema = z.object({
	title: z.string("Invalid Expense Title").min(1, "Invalid Expense Title"),
	...
	splitMode: z.enum(["equally", "parts", "specific"], "Invalid Split Mode"),
...
export const AddExpenseSchema = z.object({
	body: z.object({
		addExpenseRequest: ExpenseRequestSchema.extend({
			groupId: z.uuid("Invalid Group ID"),
		}),
	}),
});
...
export const EditExpenseSchema = z.object({
	body: z.object({
		editExpenseRequest: ExpenseRequestSchema.extend({
